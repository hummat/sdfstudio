...
"""Helper utils for processing polycam data into the sdfstudio format."""
...
from sdfstudio.process_data import process_data_utils
...
def polycam_to_json(
    ...
    if glb_filename is not None:
        ...
        # shift the axes coordinates to match the sdfstudio ones (same as the cameras' coord system)
