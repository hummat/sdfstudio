...
"""Helper utils for processing metashape data into the sdfstudio format."""
...
def metashape_to_json(
    ...
    if sensor_type.count(sensor_type[0]) != len(sensor_type):
        raise ValueError(
            ...
            "sdfstudio does not support per-frame camera_model types."
    ...
    for camera in cameras.iter("camera"):
        ...
        # Rotate the scene according to sdfstudio convention
