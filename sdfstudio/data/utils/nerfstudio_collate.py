...
"""
Custom collate function that includes cases for sdfstudio types.
"""
...
def nerfstudio_collate(batch, extra_mappings: Union[dict[type, Callable], None] = None):  # pylint: disable=too-many-return-statements
    ...
    pytorch version '1.12.1+cu113'. Custom sdfstudio types are accounted for at the end, and extra
