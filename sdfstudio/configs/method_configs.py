...
from sdfstudio.configs.base_config import (
    Config,
    SchedulerConfig,
    TrainerConfig,
    ViewerConfig,
...
from sdfstudio.data.datamanagers.semantic_datamanager import SemanticDataManagerConfig
from sdfstudio.data.datamanagers.variable_res_datamanager import (
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=NeuS2ModelConfig(
            sdf_field=SDFFieldConfig(
                ...
                # Use a hash grid capacity closer to the NeuS / default SDFFieldConfig.
                base_res=16,
                max_res=2048,
